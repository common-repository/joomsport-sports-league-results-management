...
<div>
    <form action="" name="formMatchAddFE" id="formMatchAddFE">
        <table class="table table-striped">
            <tr>
                ...
                <td>
                    ...
                    if(count($seasons)){
                        ...
                        echo '<option value="0">'.esc_html__('Select','joomsport-sports-league-results-management').'</option>';
            ...
            <tr>
                <td class="jsleft">
                    <label><?php echo esc_html__("Select Matchday", "joomsport-sports-league-results-management");?></label>
                </td>
                <td>
