...
class JoomSportTaxonomyDropClub{
    ...
    public function drop_meta_box($post) {
        ...
        <div class="tagsdiv" id="<?php echo esc_attr($this->name); ?>">
            ...
            $tx = JoomsportTermsMeta::getTerms('joomsport_club', array("hide_empty" => false));


            echo '<select name="joomsport_club" id="joomsport_club_inseas_id" class="postform" aria-required="true">';
                echo '<option value="-1">'.esc_html__('Select Club','joomsport-sports-league-results-management').'</option>';
